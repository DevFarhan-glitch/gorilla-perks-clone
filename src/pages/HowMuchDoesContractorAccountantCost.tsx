          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Most specialist contractor accountants in the UK charge a fixed monthly fee. Here is what you can generally expect across different price points:
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                One thing many contractors miss when comparing prices: VAT is charged on top by most accountancy firms. So a fee advertised at £100 per month will actually cost £120 once VAT is added. Always check whether the price quoted is inclusive or exclusive of VAT before you sign up.
              </p>

              <div className="my-10 rounded-xl overflow-hidden shadow-md">
                <img
                  src="/Fees.jpeg"
                  alt="Contractor Accountant Fees and Cost Breakdown"
                  className="w-full object-cover"
              ...
              <div className="w-10 h-0.5 bg-amber-500 mb-6" />
              <p className="text-gray-700 leading-relaxed mb-4">
                Before comparing quotes, it helps to understand how contractor accountants structure their pricing. Price is only one factor when choosing an accountant. It's also worth considering their experience with contractors, the level of support they provide and the services included in their package. Read our <Link to="/how-to-choose-contractor-accountant" className="text-amber-700 underline hover:text-amber-900">guide on how to choose a contractor accountant</Link> to understand what to look for before making your decision.
              </p>
              ...
              <div className="space-y-4 mb-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  <strong>One-off fees</strong> apply to specific tasks that fall outside a standard package — things like company formation, IR35 contract reviews or mortgage reference letters. Some firms include these in their monthly fee; others charge separately. This is worth clarifying before you commit to any package.
                </p>
              </div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
                ...
                <li>Self Assessment personal tax return for you as a director</li>
                <li>Director payroll set up and run each month</li>
                <li>VAT registration and quarterly VAT returns</li>
                <li>Access to cloud bookkeeping software such as FreeAgent or Xero</li>
                ...
                <li>Salary and dividend planning advice</li>
              </ul>
              <p className="text-gray-700 leading-relaxed mb-8">
                This covers the core of what most limited company contractors need to stay compliant and run their finances efficiently throughout the year. If you'd like to see everything that's typically included, explore our <Link to="/services/contractor-accountants" className="text-amber-700 underline hover:text-amber-900">contractors accounting services</Link> to learn how specialist support can help keep your business compliant and tax efficient.
              </p>
              ...
              <div className="w-10 h-0.5 bg-amber-500 mb-6" />
              <p className="text-gray-700 leading-relaxed mb-4">
                Yes — and this is something many contractors do not fully appreciate when they first look at the monthly cost. Accountancy fees are a legitimate and allowable business expense under HMRC's guidelines on allowable expenses, which means they are deducted from your company's profits before corporation tax is calculated.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
